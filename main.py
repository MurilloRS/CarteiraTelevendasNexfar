...
from sql import Telev, carteiraTelev, cliente
...
def verificar_combinacao(cd_clien, cd_vend, aba):
    ...
    # Imprimir os valores antes da execução da consulta SQL
    # print("cd_clien:", cd_clien_str)
    # print("cd_vend:", cd_vend_str)
    ...
    if row:
        ...
        text_box.insert(tk.END, mensagem)
        if aba == "Incluir":
            # mensagem_insert = "Executando INSERT..."
            # text_box.insert(tk.END, mensagem_insert)
...
# Componente de texto para exibir mensagens
